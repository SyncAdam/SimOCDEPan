...
<html>
    ...
    <body style="background: url('infoskep.png') no-repeat; background-size: cover; background-position-x: center; background-attachment: fixed;  ">
        <header>
        <div class="container">
            <div id="branding">
            ...
            <ul>
                ...
                <li><a href="documents.html"><p>Documents</p></a></li>
            </ul>
            </nav>
        </div>
        </header>
        ...
        <section id="infospratiquesshowcase">
            <div class="showcasecontainer" style="padding-top: 80px">
            <h2>conférence OCDE au lycée <span style="color: #8bd4ff;">Kölcsey</span></h2>
            <h1>Infos Pratiques</h1>
            </div>
            <div style="padding: 50px 0 50px 0"></div>
        </section>
        ...
        <section id="infospratiquescontent">
            ...
            <div class="infospratiquesbox">
                <h2 style="color: red">Mesures sanitaires</h2>
                <p style="color: red">Les mesures sanitaires en vigueur sont plainement appliquées dans notre établissement:</p>
                <ul>
                    <li style="color: red">Masque obligatoire</li>
                    <li style="color: red">Vaccination complète pour les professeurs accompagnateurs</li>
                </ul>
            </div>
            <div class="infospratiquesbox">
